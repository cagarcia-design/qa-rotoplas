...
|---|---|---|---|---|---|
| 1 | **Header y Footer** *(ex "Cascarón global")* | — | `1-global-layout` + `0-links` ✓ | buscador busca · links a destino ⏳ | ⏳ |
| 2 | **Home** | `/` ✓ | `1-home` ✓ | selector soluciones navega ⏳ | ⏳ |
| 3 | **Catálogo / PDP** | 7 categorías ✓ | `1-pdp` + `1-catalog` ✓ | **add-to-cart real, galería, filtros, acordeones, CP** *(esta fase, §8)* | ⏳ |
| 4 | **Servicios** | ✓ | `1-servicios` + `1-servicio-lavado` ✓ (N1) | compra del servicio ⏳ | ⏳ |
| 5 | **Institucional** | contacto/faq/distribuidores/legales ✓ | `1-contacto`·`1-faq`·`1-distribuidores`·`1-legales` ✓ | contacto submit · faq acordeón · distrib. encadenado ⏳ | ⏳ |
| 6 | **Compra (carrito → pago)** 🔒 *(ex "Ruta del dinero")* | cart/checkout1 ✓ | `2-cart-empty` + `2-money-path` ✓ | `3-money-path-purchase` ✓ *(mutante, candado)* | ⏳ |
| 7 | **Mi cuenta** 🔒 | — | `2-customer` ✓ | `1-login` ✓ *(mutante, candado)* | ⏳ |
